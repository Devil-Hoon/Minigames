...
public class CardMemoryGame_Stage4Manager : MonoBehaviour
{
	...
	[Header("Stage Level")]
	public GameObject[] stage4Levels;

	[Header("Round Image")]
	public GameObject stageClear;
	public GameObject stageFail;
	public GameObject[] stage4Rounds;
					...
					if (GameEnd())
					{
						if (!gameAllClear)
						{
							...
							else
							{
								...
								{
									waitTime = 0.0f;
									if (level != LEVEL_FOUR.FIVE)
									{
										SetLevel();
										GameInit(level);
									}
									else if (level == LEVEL_FOUR.FIVE)
									{
										gameAllClear = true;
	...
	{
		for (int i = 0; i < stage4Rounds.Length; i++)
		{
			stage4Rounds[i].SetActive(false);
		}
	}
	...
	public void SetLevel()
	{
		...
		{
			case LEVEL_FOUR.ONE:
				level = LEVEL_FOUR.TWO;
				break;
			case LEVEL_FOUR.TWO:
				level = LEVEL_FOUR.THREE;
				break;
			case LEVEL_FOUR.THREE:
				level = LEVEL_FOUR.FOUR;
				break;
			case LEVEL_FOUR.FOUR:
				level = LEVEL_FOUR.FIVE;
				break;
			case LEVEL_FOUR.FIVE:
				break;
			default:
				break;
		}
	...
	public void GameInit(LEVEL_FOUR level)
	{
		tempTimeCheck = false;
		checkTime = false;
		...
		clearEffect = false;
		BGSoundManager.instance.StopBGM();
		BGSoundManager.instance.PlayCardMemoryGameStage4BGM();
		...
		{
			case LEVEL_FOUR.ONE:
				stage4Rounds[0].SetActive(true);
				GetPoses(stage4Levels[0]);
				break;
			case LEVEL_FOUR.TWO:
				stage4Rounds[1].SetActive(true);
				GetPoses(stage4Levels[1]);
				break;
			case LEVEL_FOUR.THREE:
				stage4Rounds[2].SetActive(true);
				GetPoses(stage4Levels[2]);
				break;
			case LEVEL_FOUR.FOUR:
				stage4Rounds[3].SetActive(true);
				GetPoses(stage4Levels[3]);
				break;
			case LEVEL_FOUR.FIVE:
				stage4Rounds[4].SetActive(true);
				GetPoses(stage4Levels[4]);
				break;
			default:
				break;
		}
